...
public struct SwipeMenuViewOptions {
    ...
    public struct TabView {
        ...
        public struct ItemView {
            ...
            public var font: UIFont = UIFont(font: (name: UIFont.FontName.karla, varient: UIFont.FontVarient.bold), size: 14) ?? UIFont.systemFont(ofSize: 14.0)
        ...
        public struct AdditionView {
            ...
            public var padding: UIEdgeInsets = UIEdgeInsets(top: 0, left: 20, bottom: 0, right: 20)
